...
var unbanIcon = $('<svg t="1639975523509" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="17395" width="20" height="20"><path d="M507.380796 573.065797c32.361035 0 58.83806 26.477025 58.83806 58.83806 0 20.593014-11.768021 40.818661-29.41903 49.644677l0 68.030419c0 17.652032-11.768021 29.41903-29.41903 29.41903-17.651009 0-29.41903-11.768021-29.41903-29.41903l0-68.030419c-17.651009-8.826016-29.41903-29.051663-29.41903-49.644677C448.543759 599.543845 475.020784 573.065797 507.380796 573.065797zM507.380796 131.783419c-97.783047 0-176.513156 78.731132-176.513156 176.513156l0 117.675096c-64.721047 0-117.675096 52.954049-117.675096 117.67612l0 235.351216c0 64.72207 52.954049 117.675096 117.675096 117.675096l353.026312 0c64.721047 0 117.675096-52.954049 117.675096-117.675096l0-235.351216c0-64.72207-52.954049-117.67612-117.675096-117.67612L389.7057 425.971671l0-117.675096c0-66.963111 50.713009-117.67612 117.675096-117.67612 66.963111 0 117.675096 50.713009 117.675096 117.67612l0 29.41903 58.83806 0 0-29.41903C683.893952 210.514551 605.163843 131.783419 507.380796 131.783419z" p-id="17396" fill="#999999"></path></svg>');
...
function getCommentData() {
    $.ajax({
        ...
        error: function (jqXHR, textStatus, error) {
            showTipModal("初始化评论管理时发生不可预计的错误: " + error);
            $(".modal-close").click(function () {
                closeTipModal();
            });
...
function getBanData() {
    $.ajax({
        ...
        error: function (jqXHR, textStatus, error) {
            showTipModal("初始化禁言管理时发生不可预计的错误: " + error);
            $(".modal-close").click(function () {
                closeTipModal();
            });
...
function initBan(items) {
    ...
    for (var i in items) {
        ...
        var reason_container = $('<div class="col-4"></div>').append(reason);
        var time_container = $('<div class="col-2"></div>').append(time);
        var unban_container = $('<div class="col-2"></div>').append(unban);

        var all_container = $('<div class="list-group-item list-group-item-action"></div>')
            .append($('<div class="row"></div>')
                .append(username_container, start_contianer,
                    reason_container, time_container, unban_container));

        $("#ban-container").append(all_container);
